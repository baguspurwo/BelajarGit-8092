...
<table border="1">
	...
	<tr>
		...
		<td>
			<a href="dsiswa.php?id=<?php echo $a['id_siswa']?>">Detail
		</td>
		<td>
			<a href="usiswa.php?id=<?php echo $a['id_siswa']?>">Edit
		</td>
		<td>
			<a href="delsiswa.php?id=<?php echo $a['id_siswa']?>">Delete
		</td>
...
<a href="usiswa.php?id=<?php echo $a['id_siswa']?>">Tambah